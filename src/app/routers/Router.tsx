...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: ROUTES.COMPARE_PROF_ONE(), element: <CompareProfessorPage /> },
      { path: ROUTES.COMPARE_PROF_TWO(), element: <CompareProfessorPage /> },
      { path: ROUTES.COMPARE_PROF_THREE(), element: <CompareProfessorPage /> },
      { path: ROUTES.COMPARE_UNIVERSITY, element: <CompareUniversityPage /> },
      { path: ROUTES.COMPARE_UNIV_ONE(), element: <CompareUniversityPage /> },
      { path: ROUTES.COMPARE_UNIV_TWO(), element: <CompareUniversityPage /> },
